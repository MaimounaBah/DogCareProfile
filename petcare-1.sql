...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 11 déc. 2020 à 16:03
...
--
-- Déchargement des données de la table `chenils`
--
...
--
-- Structure de la table `gardienspart`
--
...
--
-- Déchargement des données de la table `gardienspart`
--
...
--
-- Structure de la table `pertechien`
--
...
CREATE TABLE IF NOT EXISTS `pertechien` (
  ...
  `DESCP` text COLLATE utf8mb4_bin NOT NULL,
  `RACEP` varchar(25) COLLATE utf8mb4_bin NOT NULL,
  `LIEUP` text COLLATE utf8mb4_bin NOT NULL,
...
--
-- Déchargement des données de la table `pertechien`
--
...
(2, 'aa', '', '\"\"', '', '', ''),
(3, '11111', '', '\"\"', '111', '', '111'),
(4, 'aaa', 'aaa', '\"\"', 'aaaa', '1111', 'aaa'),
(5, 'aaa', 'aaa', '\"\"', 'aaaa', '1111', 'aaa'),
(6, 'pipi', 'pipipipipipipi', 'race', 'toulouse', '11111111', '1111111');

-- --------------------------------------------------------

--
-- Structure de la table `profil_client_complete`
--
...
--
-- Déchargement des données de la table `profil_client_complete`
--
...
--
-- Structure de la table `profil_gardien_complete`
--
...
--
-- Déchargement des données de la table `profil_gardien_complete`
--
...
--
-- Structure de la table `sejourner`
--
...
--
ALTER TABLE `chiens`
  ADD CONSTRAINT `chiens_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `projetdogcare`.`client` (`id_client`),
  ADD CONSTRAINT `chiens_ibfk_2` FOREIGN KEY (`IDR`) REFERENCES `races` (`IDR`);
...
ALTER TABLE `demandes`
  ADD CONSTRAINT `demandes_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `client` (`id_client`),
  ADD CONSTRAINT `demandes_ibfk_2` FOREIGN KEY (`id_gardien`) REFERENCES `gardien` (`id_gardien`);

--
-- Contraintes pour la table `gardien`
--
ALTER TABLE `gardien`
  ADD CONSTRAINT `gardien_ibfk_1` FOREIGN KEY (`id_role`) REFERENCES `roles` (`id_role`);

--
-- Contraintes pour la table `profil_client_complete`
--
ALTER TABLE `profil_client_complete`
  ADD CONSTRAINT `profil_client_complete_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `client` (`id_client`);

--
-- Contraintes pour la table `profil_gardien_complete`
--
ALTER TABLE `profil_gardien_complete`
  ADD CONSTRAINT `profil_gardien_complete_ibfk_1` FOREIGN KEY (`id_gardien`) REFERENCES `gardien` (`id_gardien`);
COMMIT;
