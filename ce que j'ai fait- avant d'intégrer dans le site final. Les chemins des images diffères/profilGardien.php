<?php
    ...
    if(isset($_GET['id_gardien']) AND $_GET['id_gardien']>0){
        ...
        $client = $bdd->prepare("SELECT nom_client, prenom_client ,tel_client FROM client,demandes WHERE client.id_client=demandes.id_client AND demandes.id_gardien=?");
            ...
            <div class="w3-content w3-margin-top" style="max-width:1400px;">
                ...
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container w3-card w3-white">
                        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Mes demandes</h2>
                        <div class="w3-container">
                            <h5 class="w3-opacity"><b>CLient : <?php foreach ($reCli as $output){ echo $output['nom_client'] . " " .$output['prenom_client'] ;}?></b></h5>
                            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $infoDemandes['DATED'];?></h6>
                            <p>Objet : Bonjour, Je vous confie mon chien <strong><?php echo $chienInfo['CNOM'];?></strong> né le <strong><?php echo $chienInfo['CDN'];?></strong> de la race <strong><?php echo $racesInfo['RNOM'];?></strong>.
                             <?php echo $infoDemandes['TEXTED'];?> </p>
                            <p> <strong>Téléphone : </strong><?php echo $output['tel_client']?> </p>
                            <hr>
                        </div>
